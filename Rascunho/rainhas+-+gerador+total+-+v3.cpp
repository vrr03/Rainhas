...
void gera(unsigned int x, float* e, int k, unsigned int t, unsigned int* n_sol, float*** R, float** S, unsigned int** memoria)
{
    ...
    {   
        // // Se t-k-1 é um índice válido do espaço baricentrico:
        // if(t-k-1 >= 0)
        // {
        //     // Para todos os índices anteriores a t-k:
        //     for(int j = 0; j <= int(t-k-1); j++)
        //     {
        ...
        //             gera(x, e, k-1, t, n_sol, R, S, memoria);
        //             // Desmarca o índice da memória:
        //             (*memoria)[j] = 0;
        //         }
        //     }
        //     // Para todos os índices seguintes a t-k e anteriores a t:
        //     for(int j = int(t-k+1); j <= int(t-1); j++)
        //     {
        //         if(componente_valida(x, k, e[j], S, (*memoria)[j]))
        //         {
        //             // Insere elemento posterior válido em magnitude em relação à origem:
        ...
        // } else
        // {
        //     // Para todos os índices anteriores a t:
        ...
        // if(t+k-1 <= int(x-1))
        // {
        //     // Para todos os índices seguintes a t e anteriores a t+k:
        //     for(int j = t+1; j <= int(t+k-1); j++)
        //     {
        //         if(componente_valida(x, k, e[j], S, (*memoria)[j]))
        //         {
        //             // Insere elemento posterior válido em magnitude em relação à origem:
        ...
        //         }
        //     }
        //     // Para todos os índices seguintes a t+k e anteriores a x:
        //     for(int j = t+k+1; j <= x-1; j++)
        //     {
        //         if(componente_valida(x, k, e[j], S, (*memoria)[j]))
        //         {
        //             // Insere elemento posterior válido em magnitude em relação à origem:
        ...
        // } else
        // {
        //     // Para todos os índices seguintes a t:
        ...
        for(int j = 0; j <= x-1; j++)
        {
            if(j != t-k && j != t && j != t+k && componente_valida(x, k, e[j], S, (*memoria)[j]))
            {
                // Insere elemento posterior válido em magnitude em relação à origem:
                (*S)[k] = e[j];
                // Marca o índice como utilizado na memória:
        ...
        // for(int j = 0; j != t-k, j != t, j != t+k, j < x; j++)
        // {
        //     if(componente_valida(x, k, e[j], S, (*memoria)[j]))
        //     {
        //         // Insere elemento posterior válido em magnitude em relação à origem:
        ...
        //     }
        // }
        // // Para todas as possibilidades entre a (t+k)-ésima e a x-ésima possibilidade do espaço de possibilidades ordenado:
        // for(int j = t+k+1; j <= int(x-1); j++)
        // {
        //     if(componente_valida(x, k, e[j], S, (*memoria)[j]))
        //     {
        //         // Insere elemento posterior válido em magnitude em relação à origem:
...
void gerador(unsigned int x, float* e, unsigned int* n_sol, float*** R)
{
    ...
    for(int i = 0; i <= int(x-1); i++)
    {
        ...
        gera(x, e, x-1, t, n_sol, R, &S, &memoria);
        memoria[i] = 0;
    }
